  ...
  works: [
    {
      ...
      tags: ['브랜드필름', '캠페인', '편집'],
      thumbnail: { src: '', alt: '' },
      embed: { type: 'youtube', id: 'cuiiG0IT_Qc' },
      link: 'https://youtube.com/shorts/cuiiG0IT_Qc?feature=share',
    ...
    },
    {
      ...
      tags: ['숏폼', '광고', '모션'],
      thumbnail: { src: '', alt: '' },
      embed: { type: 'youtube', id: 'd0UbZmTYmdQ' },
      link: 'https://youtube.com/shorts/d0UbZmTYmdQ?feature=share',
    ...
    },
    {
      ...
      tags: ['공익', '홍보', '컬러그레이딩'],
      thumbnail: { src: '', alt: '' },
      embed: { type: 'youtube', id: 'sy9Hq7FOKxc' },
      link: 'https://youtube.com/shorts/sy9Hq7FOKxc?feature=share',
    ...
    },
    {
      ...
      tags: ['프로필', '숏폼', '영상제작'],
      thumbnail: { src: '', alt: '' },
      embed: { type: 'youtube', id: '7eKTQCd6W0s' },
      link: 'https://youtube.com/shorts/7eKTQCd6W0s?feature=share',
    ...
    },
    {
      ...
      thumbnail: { src: '', alt: '' },
      embed: { type: 'youtube', id: 'AAgp54mbF6o' },
